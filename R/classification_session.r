...
plot(cbind(n,a.rf), type="b", xlab="Training Instances (# Pages)", ylab="Model Accuracy")
points(cbind(n,a.svm), type="b", col="red")
points(cbind(n,a.lr),  type="b", col="blue")
legend(1000, 0.75, legend=c("RF", "SVM", "LR"), col=c("black", "red", "blue"), pch=c(1,1,1), cex=0.75)
